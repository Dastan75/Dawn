        ...
        return (
            <div className="taskOverlay">
                <div className="taskDetails">
                    <div onClick={this.props.closeDetails} className="closeButton"><SVGClose/></div>
                    <div className="sideNav">
                        <div onClick={() => this.setState({ openPanel: 'viewConverse' })} className="navItem conversation"><SVGConversation/></div>
                        <div onClick={() => this.setState({ openPanel: 'viewSubTasks' })} className="navItem subTasks"><SVGSubtasks/></div>
                        <div onClick={() => this.setState({ openPanel: 'viewFiles' })} className="navItem files"><SVGFiles/></div>
                                ...
                                <div className="contents">
                                    ...
                                    <div className="filesList">
                                        <div className="fileItem">
                                            <div className="fileAttachment"></div>
                                ...
                                <div className="contents">
                                    ...
                                    <div className="taskRow">
                                        <div className="taskItem">
                                            ...
                                            <div className="statusSquare"></div>
                                        </div>
