    ...
    render() {
        return (
            <svg className='LeftMenuSVG clickable' fill='none' viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'>
                <path d='M24 26H8C6.9 26 6 25.1 6 24V10C6 8.9 6.9 8 8 8H24C25.1 8 26 8.9 26 10V24C26 25.1 25.1 26 24 26Z' stroke={this.props.fill} strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit='10' strokeWidth='2'/>
                <path d='M6 13H26' stroke={this.props.fill} strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit='10' strokeWidth='2'/>
                ...
                <path d='M11 9V6' stroke={this.props.fill} strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit='10' strokeWidth='2'/>
                <path d='M21 9V6' stroke={this.props.fill} strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit='10' strokeWidth='2'/>
            </svg>
        );
    }
}
